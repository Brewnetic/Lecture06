...
* **Files**: Lecture5Examples.java (method: ifStatementExamples)  
...
### **⛓️ Ex 4: If-Else-If Chains**

* **Files**: Lecture5Examples.java (method: ifElseIfElseExamples)  
...
* **Files**: Lecture5Examples.java (method: stringComparisonExamples)  
...
* **Files**: Lecture5Examples.java (method: logicalOperatorsExamples)  
...
* **Files**: Lecture5Examples.java (method: switchStatementExamples)  
...
* **Files**: Lecture5Examples.java (method: incrementDecrementExamples)  
...
* **Files**: Lecture5Examples.java (method: forLoopExamples)  
...
* **Files**: Lecture5Examples.java (method: foreachLoopExample)  
...
* **Files**: Lecture5Examples.java (method: whileLoopExamples)  
...
* **Files**: Lecture5Examples.java (method: doWhileLoopExample)  
...
* **Files**: Lecture5Examples.java (method: breakExamples)  
...
* **Files**: Lecture5Examples.java (method: nestedLoopExample)  
...
### **🛠️ Ex 15: Helper Methods**

* **Files**: Lecture5Examples.java (method: methodExamples)  
